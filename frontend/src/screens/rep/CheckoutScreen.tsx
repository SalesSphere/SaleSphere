...
const CheckoutScreen = () => {
  const { allProductData = [], allProductError } = useProduct();
  ...
  const input =
    "h-14 w-full px-4 py-3 border border-[#292D321A] rounded-lg focus:outline-none focus:border-none";
        ...
        <main className="flex lg:justify-between justify-center items-center lg:items-start flex-col lg:flex-row lg:gap-x-8 lg:gap-y-0 gap-y-8">
          <section className="flex flex-col p-[40px] lg:w-1/2 w-full rounded-lg bg-[#292D320D] lg:sticky lg:top-20 z-10">
            <div className="pb-4">
              ...
              <p className="text-[#292D32B2]">
                Fill in the form below to input the product information
              </p>
            </div>
            <form
              onSubmit={handleAddProducts}
              className="flex flex-col !space-y-4 h-full shrink-0"
            >
              ...
              <div className={`${label} my-4`}>
                ...
                <input
                  className={`${input} cursor-not-allowed bg-[#292D3226]`}
                  id="productPrice"
                  type="text"
                  required
                  readOnly
              ...
              <button
                type="submit"
                className="h-14 w-full bg-[#292D32] text-white rounded-lg mt-4"
              >
                Add Product
              </button>
            </form>
          ...
          <section className="p-[40px] lg:w-1/2 w-full flex flex-col items-end rounded-2xl border space-y-10 mb-5">
                ...
                {products.length > 0 && (
                  <>
                    ...
                    <TableRow className="w-fullflex justify-between">
                      ...
                      <TableCell></TableCell>
                      <TableCell></TableCell>
                      <TableCell className="font-semibold text-right pr-4">
                        ₦{total}
                      </TableCell>
                    </TableRow>
                  </>
            ...
            {products.length > 0 && (
              <button className="h-12 w-2/6 border border-[#292D32] text-[#292D32] hover:bg-[#292D32] hover:text-white rounded-lg transition duration-400">
                Checkout
              </button>
            )}
          </section>
